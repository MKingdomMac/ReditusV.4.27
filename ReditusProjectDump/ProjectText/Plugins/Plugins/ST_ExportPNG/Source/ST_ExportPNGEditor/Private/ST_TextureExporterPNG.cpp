...
#include "ST_TextureExporterPNG.h"
...
UST_TextureExporterPNG::UST_TextureExporterPNG(const FObjectInitializer& OI)
	: Super(OI)
{
...
bool UST_TextureExporterPNG::SupportsObject(UObject* Object) const
{
...
bool UST_TextureExporterPNG::ExportBinary(UObject* Object, const TCHAR* Type, FArchive& Ar, FFeedbackContext* Warn, int32 FileIndex /*= 0*/, uint32 PortFlags /*= 0*/)
{
