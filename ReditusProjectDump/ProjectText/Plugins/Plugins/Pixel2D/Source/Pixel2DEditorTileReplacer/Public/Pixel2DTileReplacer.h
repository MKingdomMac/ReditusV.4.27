...
private:
	 ...
	 */
	bool ShouldReplaceTile(const FPaperTileInfo & TileInfo, const FString& CurrentWorldMapName, const FString& CurrentTileMapName, const FPixel2DTileReplacerRow * TableRow);
