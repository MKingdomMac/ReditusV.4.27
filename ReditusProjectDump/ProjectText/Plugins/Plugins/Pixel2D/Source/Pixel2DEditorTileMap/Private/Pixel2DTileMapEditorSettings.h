...
#include "Pixel2DTileMapEditorSettings.generated.h"

// Settings for the Pixel2D tile map editor
UCLASS(config=EditorPerProjectUserSettings)
class UPixel2DTileMapEditorSettings : public UObject
{
	GENERATED_BODY()

public:
	UPixel2DTileMapEditorSettings();
