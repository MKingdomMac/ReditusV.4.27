...
#include "Pixel2DImporterSettings.generated.h"
...
/**
 * Implements the settings for imported Pixel2D assets.
 */
UCLASS(config=Editor, defaultconfig)
class PIXEL2DEDITORTILEMAP_API UPixel2DImporterSettings : public UObject
{
	GENERATED_BODY()
...
public:
	...
	void ApplySettingsForTileMapInit(UPixel2DTileMap* TileMap, UPaperTileSet* DefaultTileSet = nullptr, ESpriteInitMaterialLightingMode LightingMode = ESpriteInitMaterialLightingMode::Automatic, ESpriteInitMaterialType MaterialTypeMode = ESpriteInitMaterialType::Automatic, bool bCreateEmptyLayer = true) const;
