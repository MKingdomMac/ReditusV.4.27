...
public:
	...
	void Construct(const FArguments& InArgs, TSharedRef<class FPixel2DEditorViewportClient> InViewportClient);
...
protected:
	...
	TSharedPtr<class FPixel2DEditorViewportClient> Pixel2DViewportClient;
